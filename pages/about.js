...
export default function About() {
  return (
    <Layout page="Présentation">
      <div className="bg-yellow-100 overflow-hidden-white sm:w-full lg:h-450 text-center sm:text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="space-y-7">
            ...
            <div className="flex flex-wrap -mx-1 lg:-mx-auto ">
              ...
              <div className="w-full md:w-1/2 lg:w-1/2  mb-4">
                <p className="flex items-center text-gray-800 lg:mx-auto lg:text-2xl text-yellow-500 ">
                  ...
                  de projets, elle est avant-gardiste dans le
                  micro-entrepreneur, elle vient en aide à de nombreuses femmes
                  issues de ces quartiers dit défavorisés et qui veulent se
                  lancer dans la concrétisation de leur projet. Femme Relais
                  Etoile a pris sa retraite en même temps que sa fondatrice,
